...
const powerUps = {
  ...
  coin : {
    ...
    effect() {
      powerUps.coin.changeCoin(1)
      game.makeTextLog(`<div class='circle coin'></div> &nbsp; <span style='font-size:115%;'><strong>coins:</strong> ${powerUps.coin.coins}</span>`, 300)
    },
    changeCoin(amount) {
      powerUps.coin.coins += amount
      if (powerUps.coin.coins < 0) powerUps.coin.coins = 0
    },
  },
  reroll: {
    rerolls: 0,
